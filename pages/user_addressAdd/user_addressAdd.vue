	...
	<view class="">
		<view class="myRowBetween mglr4">
			<view class="item flexRowBetween pdtb15 borderB1">
				...
				<view class="rr fs13">
					<input type="text" v-model="submitData.name" placeholder="请输入真实姓名" placeholder-class="placeholder">
				</view>
			</view>	
			<view class="item flexRowBetween pdtb15 borderB1">
			...
			<view class="item flexRowBetween pdtb15 borderB1">
				...
				<view class="rr fs13" >
					<input type="text" placeholder="如街道、门牌号" placeholder-class="placeholder" v-model="submitData.detail">
				</view>
			</view>	
			<view class="item flexRowBetween pdtb15 borderB1">
				<view class="ll">设为默认地址</view>
				<view class="rr">
					<switch @change="choose" :checked="submitData.isdefault==1?true:false" style="transform:scale(0.75);" 
					color="#ff5c11" />
				</view>
			</view>	
			
			<view class="submitbtn"  style="margin-top: 200rpx;">
				<button class="btn" type="button"  @click="Utils.stopMultiClick(submit)">确认</button>
			</view>
		</view>
	</view>
</template>
